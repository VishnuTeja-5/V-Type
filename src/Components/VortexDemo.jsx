  ...
  return (
    (<div
      ...
      <Vortex
        ...
        <div className='w-full h-full border border-gray-700 rounded-lg text-emerald-600 flex flex-col justify-center bg-zinc-950 backdrop-blur-sm bg-opacity-20 lg:grid lg:grid-cols-12 '>
